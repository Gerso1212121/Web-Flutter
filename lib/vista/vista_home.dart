    ...
    return Scaffold(
        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              accountName: const Text('Carpintería Chavarría', style: TextStyle(color: Colors.white)),
              accountEmail: const Text('contacto@chavarria.com', style: TextStyle(color: Colors.white)),
            ...
            ListTile(
              title: const Text('Ofertas', style: TextStyle(color: Colors.black)),
      ...
      endDrawer: Drawer(
        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              accountName: const Text('Tu Carrito', style: TextStyle(color: Colors.white)),
              accountEmail: const Text('Carrito de compras', style: TextStyle(color: Colors.white)),
              currentAccountPicture: CircleAvatar(
                backgroundColor: Colors.white,
                child: Icon(
                  Icons.shopping_cart,
            ...
            const Divider(),
            ListTile(
              title: const Text('Ir a comprar', style: TextStyle(color: Colors.black)),
